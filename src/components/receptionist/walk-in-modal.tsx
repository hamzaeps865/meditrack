     ...
     <div className="bg-white  border border-border w-full max-w-md max-h-[90vh] overflow-y-auto">
      ...
      <div className="p-5 space-y-4">
       {!selectedPatient ? (
        <div>
         ...
         <div className="relative">
          ...
          <input
           className="w-full h-10 pl-9 pr-3 border border-border bg-muted/30 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
       ...
       <div>
        ...
        <select className="w-full h-10 px-3 border border-border bg-muted/30 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" value={doctorId} onChange={(e) => setDoctorId(e.target.value)}>
       ...
       <div>
        ...
        <input className="w-full h-10 px-3 border border-border bg-muted/30 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20" value={reason} onChange={(e) => setReason(e.target.value)} placeholder="e.g. Fever, check-up" />
       </div>
       ...
       <div className="flex justify-end gap-2 pt-2">
        ...
        <button type="button" onClick={handleSubmit} disabled={isPending || !selectedPatient} className="h-10 px-5 bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 disabled:opacity-60 flex items-center gap-2">
