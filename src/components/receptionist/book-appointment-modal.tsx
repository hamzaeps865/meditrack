  ...
  >
   ...
   >
    ...
    <form onSubmit={handleSubmit} className="flex-1 flex flex-col px-6 py-5 gap-5">
     ...
     <div>
      ...
      <div className="relative">
       ...
       <input
        ...
        className="w-full h-10 pl-9 pr-4 border border-border bg-background
      ...
      {!selectedPatient && patientResults.length > 0 && (
       <div className="mt-1 border border-border bg-card shadow-sm overflow-hidden">
        {patientResults.map((p) => (
         ...
         >
          <div className="h-7 w-7 bg-primary/10 text-primary
      ...
      {selectedPatient && (
       <div className="mt-2 inline-flex items-center gap-1.5 px-3 py-1 
     ...
     <div>
      ...
      <div className="relative">
       <select
        ...
        className="w-full h-10 px-3 pr-8 border border-border bg-background
      ...
      <div>
       ...
       <div className="relative">
        ...
        <input
         ...
         className="w-full h-10 pl-9 pr-3 border border-border bg-background
     ...
     <div>
      <div className="bg-muted/50 px-4 pt-3 pb-4">
     ...
     <div>
      ...
      <div className="relative">
       ...
       <textarea
        ...
        rows={3}
        maxLength={1000}
        className="w-full pl-9 pr-3 py-2.5 border border-border bg-background
     ...
     <div>
      <div className="flex flex-col items-center justify-center gap-1.5
       border border-dashed border-border py-5 px-4
     ...
     <div className="flex gap-3 pt-2 pb-1 border-t border-border">
      <button
       ...
       className="flex-1 h-11 bg-primary text-primary-foreground text-sm
      ...
      <button
       type="button"
       onClick={onClose}
       className="h-11 px-5 border border-border text-foreground text-sm
