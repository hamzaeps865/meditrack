   ...
   >
    ...
    >
     <div className="px-6 py-5 flex flex-col gap-5 flex-1">
      ...
      <div className="flex items-center gap-4 p-4 bg-muted/40 border border-border">
       <div className="relative shrink-0">
        <div className="h-14 w-14 bg-muted flex items-center
      ...
      <div>
       ...
       <textarea
        ...
        rows={2}
        className="w-full px-3 py-2.5 border border-border bg-background
     ...
     <div className="px-6 py-4 border-t border-border flex gap-3">
      <button
       type="button"
       onClick={onClose}
       className="flex-1 h-11 border border-border text-foreground
