     ...
     >
      <div className="flex items-center justify-between px-5 py-4 border-b border-border sticky top-0 bg-white">
       <div className="flex items-center gap-2">
        <div className={`h-7 w-7 flex items-center justify-center ${hasWarning ? 'bg-amber-100' : 'bg-emerald-100'}`}>
      ...
      <div className="p-5">
       ...
       {result && !loading && (
        <div className={` p-3 ${hasWarning ? 'bg-amber-50 border border-amber-200' : 'bg-emerald-50 border border-emerald-200'}`}>
