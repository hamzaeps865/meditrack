 ...
 return (
  <>
   <button
    ...
    disabled={loading}
    className="inline-flex items-center gap-1.5 h-8 px-3 border border-emerald-200 text-xs font-semibold text-emerald-700 hover:bg-emerald-50 transition-colors"
   >
       ...
       {loading ? (
        ...
        <div className="space-y-3">
         ...
         {severity && severityConfig[severity] && (
          <div className={`flex items-center gap-2 border px-3 py-2 ${severityConfig[severity].bg}`}>
           {(() => {
