            ...
            <div className="flex flex-wrap gap-2">
              {SUGGESTIONS.map((s) => (
                <button
                  ...
                  className="px-3 py-1.5 rounded-full border border-border bg-white text-xs font-medium text-foreground hover:bg-muted hover:border-primary/30 transition-all"
                >
                  {s}
                </button>
              ))}
      ...
      <div className="border-t border-border pt-3 mt-3">
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 px-3 py-2.5 rounded-xl border border-border bg-white text-sm text-foreground placeholder:text-muted-foreground/60 resize-none focus:outline-none focus:ring-2 focus:ring-primary/20"
          ...
          <button
            ...
            className="h-11 w-11 rounded-xl bg-primary text-primary-foreground flex items-center justify-center hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
          >
