...
function AddBlockForm({
 ...
 function submit() {
  ...
  return (
    <div className="mt-2 ml-[160px] flex flex-wrap items-end gap-2 pb-1">
      <div>
 ...
 return (
  <div className="space-y-6">
   ...
   <div className="bg-white border border-border overflow-hidden shadow-sm">
        ...
        {/* Table header */}
        <div className="grid grid-cols-[160px_1fr_110px] px-5 py-3
        ...
        {DAY_ORDER.map((day, dayIdx) => {
          ...
          return (
            <div key={day}
              ...
              <div className="grid grid-cols-[160px_1fr_110px] items-center px-5 py-4">
       ...
       <div className="grid grid-cols-[88px_1fr_110px] items-center px-5 py-4">
        ...
        <div className="flex items-center gap-2.5">
         ...
         <button
          ...
          onClick={() => handleToggleDay(day)}
          aria-label={active ? `Turn off ${DAY_LABELS[day]}` : `Turn on ${DAY_LABELS[day]}`}
          className={`h-6 w-11 flex items-center px-0.5
           transition-colors shrink-0 cursor-pointer
           ${active ? 'bg-primary justify-end' : 'bg-muted justify-start'}`}
         >
