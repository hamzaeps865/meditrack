...
export function HealthScoreCard({
  ...
  return (
    <div className={`bg-white rounded-2xl border p-5 shadow-sm ${tier.ring} ring-1`}>
      ...
      <span className={`inline-block px-2.5 py-1 rounded-full text-xs font-bold ${tier.bg} ${tier.color} mb-4`}>
        {tier.name} Tier
      </span>
