    ...
    <div className="min-h-full bg-[#f0f7f3]">
      ...
      <div className="bg-white border-b border-border px-6 py-3
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="pl-2.5 border-l border-border flex items-center gap-2">
            ...
            <div className="h-8 w-8 rounded-full bg-primary flex items-center
      ...
      <div className="px-6 py-5 max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit}
          className="bg-white rounded-2xl border border-border p-6 shadow-sm mb-4">
            ...
            {!selectedPatient ? (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 rounded-xl border border-border
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl
                ...
                <div className="h-9 w-9 rounded-full bg-primary text-white
                  flex items-center justify-center text-xs font-bold shrink-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-11 px-3 rounded-xl border border-border
              ...
              {ALL_SLOTS.map((slot) => {
                ...
                return (
                  <button
                    ...
                    className={`h-10 rounded-lg text-xs font-semibold border
                      transition-colors
                      ${isPast
          ...
          {/* General error */}
          {slotError && !slotError.includes('slot') && (
            <div className="mb-5 flex items-start gap-2 rounded-lg
              bg-red-50 border border-red-200 px-3 py-2.5">
              <AlertCircle className="h-4 w-4 text-red-500 shrink-0 mt-0.5" />
              <p className="text-xs text-red-600">{slotError}</p>
            </div>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2.5 rounded-xl border border-border bg-muted/30
