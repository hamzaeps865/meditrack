     ...
     <div className="bg-white  border border-border w-full max-w-md max-h-[90vh] overflow-y-auto">
      ...
      <div className="p-5 space-y-4">
       ...
       <div className="flex items-center justify-between gap-2 pt-2">
        <button type="button" onClick={handleDelete} disabled={isPending} className="h-10 px-3 border border-red-200 text-sm font-medium text-red-600 hover:bg-red-50 flex items-center gap-1.5">
