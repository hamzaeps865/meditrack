   ...
   <div className="px-6 py-5 max-w-7xl mx-auto">
    ...
    <div className="flex flex-wrap items-center justify-between gap-3 mb-4
     ...
     <div className="flex items-center gap-2 flex-wrap">
      {/* Date range pill */}
      <button type="button"
       className="flex items-center gap-1.5 h-8 px-3.5 border border-border
     ...
     <div className="flex items-center gap-2">
      ...
      <select
       ...
       className="h-8 px-2.5 border border-border bg-white text-xs
          ...
          <div className="min-w-0 pr-2">
           {p.primaryDoctor ? (
            <div className="flex items-center gap-1.5">
             <div className={`h-2 w-2 shrink-0 ${isActive ? 'bg-emerald-500' : 'bg-muted-foreground/60'}`} />
