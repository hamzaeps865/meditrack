...
const statusConfig: Record<string, {
 ...
 checked_in: { label: 'Checked-in', badge: 'bg-amber-100 text-amber-700 px-2.5 py-0.5 text-xs font-semibold' },
 in_progress: { label: 'In-progress', badge: 'bg-muted text-foreground px-2 py-0.5 text-xs font-semibold' },
  ...
  <div className="min-h-full bg-[#f0f7f3]">
   ...
   <div className="px-6 py-5 max-w-7xl mx-auto">
    ...
    <div className="flex flex-wrap items-center gap-3 mb-4">
     <div className="relative flex-1 min-w-[180px] max-w-xs">
      ...
      <input
       ...
       className="w-full h-9 pl-9 pr-3 border border-border bg-white
        text-sm text-foreground placeholder:text-muted-foreground
     ...
     <select
      ...
      className="h-9 pl-3 pr-8 border border-border bg-white text-sm
     ...
     <div className="ml-auto">
      <Link href="/admin/appointments/new"
       type="button"
       className="flex items-center gap-2 h-9 px-4 text-white
     ...
     <div className="flex items-center justify-between px-5 py-3.5
      ...
      <div className="flex items-center gap-1.5">
       <button
        ...
        className="h-8 px-3 border border-border bg-white text-sm
    ...
    <div className="premium-card premium-card-pad flex flex-col justify-between text-white"
      ...
      <button
       type="button"
       className="mt-6 w-full h-10 bg-white text-sm font-bold
