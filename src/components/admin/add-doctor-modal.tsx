...
const inputCls =
 'w-full h-12 px-4 border border-border bg-muted/30 text-sm ' +
   ...
   >
    ...
    <div className="px-6 py-5 border-t border-border grid grid-cols-2 gap-3">
     <button
      type="button"
      onClick={onClose}
      className="h-12 border border-border text-sm font-semibold
     ...
     <button
      ...
      disabled={isPending}
      className="h-12 text-sm font-bold text-white transition-colors
