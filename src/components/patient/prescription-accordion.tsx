     ...
     >
      ...
      >
       ...
       <div className="flex items-center gap-2 shrink-0">
        {rx.items.length > 0 && (
         <span className="hidden sm:flex items-center gap-1 px-2.5 py-1 
       ...
       <div className="border-t border-border">
         ...
         {rx.items.length === 0 ? (
          ...
          <div className="space-y-2">
           {rx.items.map((item, i) => (
            <div
             key={i}
             className="flex items-start gap-3 p-3 bg-muted/30
        ...
        <div className="px-5 py-3 border-t border-border flex justify-end">
         <Link
          ...
          target="_blank"
          className="inline-flex items-center gap-1.5 h-8 px-3 border border-border
