...
export default function LoginPage() {
 ...
 return (
  <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 py-10">
   <div className="bg-card shadow-sm border border-border w-full max-w-[420px] overflow-hidden">
    <div className="px-6 sm:px-[33px] pt-8 pb-6">
     ...
     {/* Mode toggle */}
     <div className="flex items-center gap-2 mb-5 bg-muted/40 p-1">
      <button
       type="button"
     ...
     {mode === 'email' && (
      <form onSubmit={handleEmailSubmit} className="space-y-4">
       ...
       <Button
        type="submit"
        className="w-full h-[48px] bg-primary hover:bg-primary/90 text-primary-foreground mt-2 cursor-pointer"
        disabled={loading}
       >
       ...
       {!otpSent ? (
        <>
         ...
         <Button
          ...
          disabled={sendingOtp}
          className="w-full h-[48px] bg-primary hover:bg-primary/90 text-primary-foreground cursor-pointer flex items-center justify-center gap-2"
         >
        ...
        <>
         <div className="bg-emerald-50 border border-emerald-200 px-3 py-2 text-xs text-emerald-700 text-center">
