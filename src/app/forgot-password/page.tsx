...
export default function ForgotPasswordPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 py-10">
      <div className="bg-card rounded-xl shadow-sm border border-border w-full max-w-[460px] overflow-hidden">
        <div className="px-6 sm:px-[33px] pt-8 pb-7">
          ...
          <Link
            href="/login"
            className="mt-6 flex items-center justify-center gap-2 w-full h-11 rounded-lg border border-border bg-card
