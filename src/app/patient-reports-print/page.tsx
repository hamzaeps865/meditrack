   ...
   <div className="max-w-3xl mx-auto space-y-6">
    ...
    {reportData && (
     <div className="grid grid-cols-4 gap-2 text-center">
      {[
       ...
       <div key={s.label} className="border border-emerald-100 p-2">
    ...
    {healthScore && (
     <div>
      ...
      <div className="border border-emerald-100 p-3">
     ...
     <div>
      ...
      <div className="space-y-3">
       {reportData.prescriptions.map((rx) => (
        <div key={rx.id} className="border border-emerald-100 p-2 text-xs">
