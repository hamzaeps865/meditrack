        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-border p-4 shadow-sm">
              ...
              {patient && (
                <Link href={`/admin/patients/${patient.id}`}
                  className="w-full flex items-center justify-center h-8 rounded-lg
            ...
            <div className="bg-white rounded-2xl border border-border p-4 shadow-sm">
              ...
              <div className="flex items-center gap-2.5 mb-3">
                <div className="h-9 w-9 rounded-full bg-emerald-100 text-emerald-700
                  flex items-center justify-center text-xs font-bold shrink-0">
                ...
                {allergyList.length > 0 && (
                  <div className="mb-2">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {allergyList.map((a) => (
                        <span key={a} className="px-2 py-0.5 rounded-full bg-red-50
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-border p-5 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                {visitRow && (
                  <span className="ml-auto px-2 py-0.5 rounded-full bg-emerald-50
