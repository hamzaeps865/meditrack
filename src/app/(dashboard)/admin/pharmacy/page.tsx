    ...
    <div className="min-h-full bg-[#f0f7f3]">
      ...
      <div className="px-6 py-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-2xl border border-border p-5 shadow-sm">
            <div className={`h-10 w-10 rounded-xl flex items-center justify-center mb-3 ${summary.lowStockCount > 0 ? 'bg-rose-50' : 'bg-muted'}`}>
          ...
          <div className="bg-white rounded-2xl border border-border p-5 shadow-sm">
            <div className={`h-10 w-10 rounded-xl flex items-center justify-center mb-3 ${summary.expiringCount > 0 ? 'bg-amber-50' : 'bg-muted'}`}>
