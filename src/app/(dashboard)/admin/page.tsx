 ...
 return (
  <div className="relative">
     ...
     return (
      ...
      >
       <div className="flex items-start justify-between">
        ...
        <div className={`${card.iconBg} ${card.iconColor} p-2.5 shrink-0`}>
   ...
   <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-4">
    ...
    <div className="bg-card border border-border overflow-hidden">
     <div className="flex items-start justify-between px-6 py-5">
      ...
      <Link
       href="/admin/appointments"
       className="px-3 py-1.5 border border-border text-xs font-medium
        ...
        {todayAppts.map((row, i) => (
         ...
         >
          ...
          <td className="px-5 py-4 text-right">
           <span className={`inline-block px-2.5 py-1 text-xs
   ...
   <Link
    ...
    className="fixed bottom-8 right-8 h-12 w-12 bg-primary
