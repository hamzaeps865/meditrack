      ...
      <div className="px-6 py-5 max-w-7xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-5">
          ...
          <a
            ...
            className="flex items-center gap-2 h-9 px-4 rounded-xl border border-border
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5">
                <input
                  ...
                  className="flex-1 min-w-0 h-9 px-2 rounded-lg border border-border
                ...
                return (
                  <li key={row.id}
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      {row.userRole && (
                        <span className={`shrink-0 px-2 py-0.5 rounded text-[9px]
                    ...
                    {/* Action badge */}
                    <div>
                      <span className={`inline-block px-2.5 py-1 rounded text-[10px]
