        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            <Link
              ...
              className="h-9 px-3.5 rounded-xl bg-white border border-border text-xs font-bold text-foreground
                ...
                <ul className="divide-y divide-border">
                  {checkedIn.map((appt) => (
                    <li key={appt.id} className="flex items-center justify-between gap-4 px-5 py-3.5 hover:bg-muted/20 transition-colors">
                      ...
                      <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide bg-amber-50 text-amber-700 border border-amber-200 shrink-0">
                        Checked-in
                      </span>
                    </li>
                  ))}
                    ...
                    return (
                      <li key={appt.id} className="flex items-center justify-between gap-4 px-5 py-3.5 hover:bg-muted/20 transition-colors">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                          ...
                          <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide border ${cfg.badge}`}>
                            {cfg.label}
                          </span>
                        </div>
                      </li>
                  ...
                  {doctorOccupancy.map((doc) => (
                    <li key={doc.id} className="p-4 space-y-1.5">
                      ...
                      {doc.activeVisitPatient ? (
                        <div className="flex items-center gap-1.5 text-xs text-orange-700 bg-orange-50 px-2.5 py-1 rounded-lg border border-orange-100 font-medium">
