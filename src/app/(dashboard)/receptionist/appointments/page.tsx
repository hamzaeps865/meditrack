 ...
 return (
  <div className="flex flex-col gap-4">
   ...
   {doctorColumns.length === 0 ? (
    <div className="bg-card border border-border flex flex-col items-center
             ...
             return (
              ...
              >
               <div className="flex items-center gap-1.5">
                <div className={`h-1.5 w-1.5 shrink-0 ${s.dot}`} />
               ...
               <span className={`inline-block mt-1 px-1.5 py-0.5 
