  ...
  <div>
   ...
   <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
    <div>
     <div className="flex items-center gap-2 flex-wrap">
      ...
      <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-muted text-xs font-medium text-muted-foreground">
    ...
    <div className="flex items-center gap-2">
     ...
     <Link
      ...
      className="flex items-center gap-1.5 h-9 px-4 bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors"
     >
   ...
   <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-4">
     ...
     <div className="bg-card border border-border p-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-wrap gap-2">
         {!patient.allergies ? (
          ...
          patient.allergies.split(',').map((a) => a.trim()).filter(Boolean).map((a) => (
           <span key={a} className="px-2.5 py-1 bg-red-50 text-red-600 text-xs font-medium">
            {a}
           </span>
          ))
         )}
       ...
       <div>
        ...
        <span className="px-2.5 py-1 bg-primary/10 text-primary text-xs font-medium">
           ...
           {upcomingAppts.map((a) => (
            <tr key={a.id} className="border-b border-border">
             ...
             <td className="px-5 py-3">
              <span className={`inline-block px-2 py-0.5 text-[10px] font-medium ${statusStyles[a.status]}`}>
    ...
    <div className="space-y-4">
     ...
     <div className=" p-5 text-primary-foreground" style={{ backgroundColor: '#01411C' }}>
      ...
      {[
       ...
       return (
        <Link
         key={action.label}
         href={action.href}
         className="flex items-center justify-between gap-2 px-3 py-2.5 text-sm text-foreground hover:bg-muted transition-colors"
        >
