  ...
  <div>
   ...
   <div className="flex items-center justify-between gap-4 mb-6">
    <div className="relative flex-1 max-w-md">
     ...
     <input
      ...
      className="w-full h-10 pl-9 pr-4 border border-border bg-card text-sm
    ...
    <div className="flex items-center gap-2">
     ...
     <button
      type="button"
      aria-label="Settings"
      className="h-9 w-9 flex items-center justify-center text-muted-foreground hover:bg-muted transition-colors"
     >
   ...
   <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
    ...
    <button
     ...
     className="flex items-center gap-1.5 h-10 px-4 bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors"
    >
   ...
   <div className="bg-card border border-border p-4 mb-4 space-y-3">
    <div className="relative">
     ...
     <input
      ...
      className="w-full h-10 pl-9 pr-4 border border-border bg-background text-sm
       text-foreground placeholder:text-muted-foreground
       focus:outline-none focus:ring-2 focus:ring-primary/20"
     />
    </div>
    ...
    <div className="flex flex-wrap items-center gap-3">
     <select
      ...
      className="h-9 px-3 border border-border bg-background text-sm text-foreground
       focus:outline-none focus:ring-2 focus:ring-primary/20"
     >
   ...
   {/* Table */}
   {loading ? (
    <div className="bg-card border border-border text-center py-20 text-muted-foreground">
     Loading patients...
    </div>
   ) : filtered.length === 0 ? (
    <div className="bg-card border border-border text-center py-20 text-muted-foreground">
         ...
         return (
          ...
          >
           ...
           <td className="px-5 py-4">
            ...
            >
             <span className={`h-8 w-8 flex items-center justify-center text-xs font-semibold shrink-0 ${avatarColor(p.name)}`}>
              {getInitials(p.name)}
             </span>
     ...
     <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-t border-border">
      ...
      <div className="flex items-center gap-1">
       <button
        ...
        className="h-7 w-7 flex items-center justify-center text-muted-foreground hover:bg-muted transition-colors disabled:opacity-40 disabled:hover:bg-transparent"
       >
       ...
       {pageNumbers().map((n, i) =>
        n === 'ellipsis' ? (
         ...
         <button
          ...
          type="button"
          onClick={() => setPage(n)}
          className={`h-7 min-w-7 px-1.5 text-xs font-medium transition-colors ${
           n === currentPage
