    ...
    <div className="bg-white border border-border p-5 shadow-sm">
     <div className="flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-4">
       <div
        className="h-14 w-14 flex items-center justify-center text-lg font-bold text-white shrink-0"
        style={{ background: 'linear-gradient(135deg, #01411C, #0a5c3a)' }}
       >
        {getInitials(userName)}
       </div>
       <div>
        ...
        <div className="flex items-center gap-2 mt-1">
         <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider
          px-2.5 py-0.5 bg-amber-50 text-amber-700 border border-amber-200">
          <UserCheck className="h-3 w-3" />
          Reception Staff
         </span>
         <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700
          bg-emerald-50 px-2 py-0.5 border border-emerald-100">
