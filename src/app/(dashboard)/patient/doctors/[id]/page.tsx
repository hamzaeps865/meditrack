    ...
    <div className="bg-white border border-border p-6 shadow-sm mb-5">
     <div className="flex items-start gap-5">
      ...
      <Link
       ...
       className="shrink-0 h-10 px-4 bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-colors flex items-center gap-1.5"
      >
       ...
       {reviews.map((review) => (
        <div key={review.id} className="border-b border-border last:border-b-0 pb-4 last:pb-0">
         <div className="flex items-center justify-between mb-1.5">
          <div className="flex items-center gap-2">
           <div className="h-7 w-7 bg-muted text-muted-foreground flex items-center justify-center text-xs font-semibold">
