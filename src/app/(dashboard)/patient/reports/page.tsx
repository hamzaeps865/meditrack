      ...
      <div className="px-6 py-8 max-w-3xl mx-auto">
        ...
        {healthScore && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
            ...
            />
            <div className="bg-white rounded-2xl border border-border p-5 shadow-sm flex flex-col justify-center">
        ...
        {!reportData ? (
          <div className="bg-white rounded-2xl border border-border p-8 text-center text-muted-foreground shadow-sm">
                    ...
                    <div key={rx.id} className="rounded-lg border border-border p-3">
                      ...
                      {rx.items.length > 0 && (
                        <div className="flex flex-wrap gap-1.5">
                          {rx.items.map((item) => (
                            <span key={item.id} className="text-[10px] px-2 py-0.5 rounded-full bg-muted text-muted-foreground">
