  ...
  <div className="min-h-full bg-[#f0f7f3]">
   ...
   <div className="px-6 py-5 max-w-5xl mx-auto">
    ...
    <div className="flex flex-wrap items-start justify-between gap-4 mb-5">
     ...
     <div className="flex items-center gap-2">
      <button type="button"
       className="flex items-center gap-1.5 h-9 px-4 border border-border
      ...
      <Link href={`/doctor/appointments?patientId=${patientId}`}
       className="flex items-center gap-1.5 h-9 px-4 bg-primary
       ...
       <div className="mb-3">
        ...
        {allergyList.length === 0 ? (
         ...
         <div className="flex flex-wrap gap-1.5">
          {allergyList.map((a) => (
           <span key={a} className="px-2.5 py-1 bg-red-50
