       ...
       {todayAppointments.map((appt) => {
        ...
        return (
         ...
         >
          ...
          {/* Next Up badge */}
          {isNextUp && (
           <span className="shrink-0 hidden sm:block px-2 py-1 
          ...
          {/* Status badge */}
          <span className={`shrink-0 px-2.5 py-1 text-[10px] font-semibold
     ...
     <div className="bg-card border border-border p-5">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
       {[
        ...
        <div key={s.label} className=" bg-muted/50 px-2 py-2 text-center">
