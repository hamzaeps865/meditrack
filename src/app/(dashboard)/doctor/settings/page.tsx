  ...
  return (
    <div className="min-h-full bg-[#f0f7f3]">
      ...
      <div className="bg-white border-b border-border px-6 py-3 flex items-center justify-between gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full h-9 pl-9 pr-4 rounded-full border border-border bg-muted/40 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:bg-white"
          />
        </div>
      ...
      <div className="px-6 py-5 max-w-3xl mx-auto">
        ...
        {/* Profile banner */}
        <div className="bg-white rounded-2xl border border-border p-5 shadow-sm mb-4 flex items-center gap-4">
